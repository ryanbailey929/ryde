...
bin/ryde_debug: $(main_debug) $(base_debug) $(mw_debug)
	$(CXX) $(main_debug) $(glad) $(base_debug) $(mw_debug) -o bin/ryde_debug \
	$(FLAGS_DEBUG) $(GL_FLAGS)
...
.PHONY: objects_debug
objects_debug: $(base_debug) $(mw_debug) $(main_debug)
